...
- App→package direction and package independence hold as written — Enforcement: structural test (import-boundary check), a Metabolize candidate; doc-only until built, priced if deferred.
